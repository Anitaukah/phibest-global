...
const WhyChooseUs = () => {
	return (
		<div className="md:m-auto md:max-w-[920px] m-auto max-w-[540px]">
			<div className="flex flex-col-reverse md:flex-row md:justify-center gap-10 relative">
				<div className="relative">
					<img className="w-52 h-72 md:w-[800px] md:h-80" src={Image42} alt="img 42" />
					<div className="absolute bottom-0 md:-right-[42px] right-28">
						<img className="md:h-32 h-28" src={Image43} alt="" />
					</div>
				</div>
				<div className="mt-8">
					<h1 className="text-3xl md:text-4xl mb-4 font-semibold">Why Choose Us</h1>
