...
const Services = () => {
	return (
		<div className="m-auto w-[960px] min-w-64" id="Services">
			<div>
				...
				<div className="grid grid-cols-3">
					<img className="h-52 w-72 rounded-lg shadow-[0_3px_6px_#00000029,0_3px_6px_#0000003b]" src={Image7} alt="" />
					<img className="h-52 w-72 rounded-lg shadow-[0_3px_6px_#00000029,0_3px_6px_#0000003b]" src={Image9} alt="" />
					<img className="h-52 w-72 rounded-lg shadow-[0_3px_6px_#00000029,0_3px_6px_#0000003b]" src={Image8} alt="" />
				</div>
			</div>
			...
			<div className="mt-8">
				...
				<div className="grid grid-cols-3">
					<img className="h-52 w-72 rounded-lg shadow-[0_3px_6px_#00000029,0_3px_6px_#0000003b]" src={Image12} alt="" />
					<img className="h-52 w-72 rounded-lg shadow-[0_3px_6px_#00000029,0_3px_6px_#0000003b]" src={Image10} alt="" />
					<img className="h-52 w-72 rounded-lg shadow-[0_3px_6px_#00000029,0_3px_6px_#0000003b]" src={Image11} alt="" />
				</div>
				<p className="pt-8">
