			...
			<div>
							...
							<div className="flex flex-col-reverse md:flex-row md:justify-between gap-4 mx-2 md:gap-5">
								...
								<div className="md:w-[400px] w-[350px]">
									<div className="flex items-center justify-center gap-4">
										...
										<h1 className="pb-4 font-bold text-4xl">
											About Us
										</h1>
										<div className="w-10 h-2 bg-[#0000FA] rounded-tr-lg rounded-br-lg"></div>
									</div>
									<p className="text-base text-center ">
										Phibest Global Services Limited is a company based
										in Nigeria providing services in Nigeria to oil
										and oil service companies for their offshore and
										onshore activities.
									</p>
								</div>
							</div>
				...
				<div className="mx-4 pt-3">
					...
					<p className=" text-base text-justify md:m-auto md:max-w-[920px] m-auto max-w-[540px]">
						Phibest Global Services Limited provides services in the field
						of Civil and Fabrication Engineering, Bitumen cleaning and
						oil-based mud (OBM), Waste management, maintenance, welding,
						blasting and painting services. Tank cleaning is crucial in
						industrial settings such as manufacturing facilities,
						Refineries and Power plants. As Professional tank cleaning
						services, we have the necessary expertise and equipment to
