...
const About = () => {
	return (
		<div>
			<div className="m-auto w-[1200px] min-w-64">
			...
			<div className="border-2 border-black pt-3">
				<p className="m-auto w-[1200px] min-w-64 text-lg text-justify">
				...
				<div className=" bg-[#D9D9FE] mt-8">
					<div className="m-auto w-[1200px] min-w-64 grid grid-cols-3 items-center gap-y-4 py-10 pl-8">
						<img
							className="h-56 w-[360px] rounded-lg shadow-[#B0B0FD_0px_5px_15px] transition-all duration-200 ease-in-out hover:transform  hover:scale-110"
							src={Image3}
							alt=""
						/>
