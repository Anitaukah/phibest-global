			...
			<div className=" relative overflow-hidden text-white bg-black/65 mt-3">
				<section className="md:m-auto md:max-w-[920px] m-auto max-w-[540px]">
					...
					<div className="h-[80vh] flex flex-col justify-center items-center gap-10 text-center w-full max-w-6xl mx-auto">
						<p className="md:text-5xl text-3xl text-white animate__animated animate__fadeInDown">
							Reliable Industrial Cleaning & Maintenance Services
						</p>

						<p className="text-xl md:text-3xl text-white text-center animate__animated animate__fadeInDown">
